...
class MediaLibrarySessionCallback(
    ...
    override fun onConnect(
        ...
        val availableSessionCommands = connectionResult.availableSessionCommands.buildUpon()
            .add(SessionCommand(com.jooheon.features.musicservice.MusicService.Companion.TOGGLE_SHUFFLE, Bundle.EMPTY)).also {
                it.add(SessionCommand(com.jooheon.features.musicservice.MusicService.Companion.CYCLE_REPEAT, Bundle.EMPTY))
            }
    ...
    override fun onCustomCommand(
        ...
        when (customCommand.customAction) {
            com.jooheon.features.musicservice.MusicService.Companion.CYCLE_REPEAT -> {
                val value = (session.player.repeatMode.defaultZero() + 1) % 3
                session.player.repeatMode = value
            }
            com.jooheon.features.musicservice.MusicService.Companion.TOGGLE_SHUFFLE -> {
